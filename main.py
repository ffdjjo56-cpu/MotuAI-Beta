...
async def get_gemini_response(text):
    ...
    for i, api_key in enumerate(keys_pool):
        try:
            ...
            prompt = (
                ...
                "Ты сидишь в чате и просто стебёшься над всеми. "
                "Твой стиль: пиши сплошным текстом без переносов строк. "
                "Делай грамматические ошибки, иногда пиши КАПСОМ. "
                "ЗАПРЕЩЕНО: смайлики, жирный текст (**), тире, дефисы, нижние подчеркивания. "
    ...
    return "слыш у меня даже 35 ключей сдохли от твоей рожи вали отсюда"
